...
public class RxCityService {
    ...
    public static RxCityService getInstance(){
        if (apiRetrofit == null){
            synchronized (Object.class){
                if (apiRetrofit == null){
                    apiRetrofit = new RxCityService();
                }
            }
        }
