...
public class RxNewsService {
    ...
    public static RxNewsService getInstance(){
        if (apiRetrofit == null){
            synchronized (Object.class){
                if (apiRetrofit == null){
                    apiRetrofit = new RxNewsService();
                }
            }
        }
